  ...
  describe('Part I', function() {
    ...
    describe('identity', function() {
      ...
      it('should return whatever value is passed into it', function() {
        ...
        // _.identity({name: "karen"}) === {name: "karen"} yields false
        //_.identity([1,3,5,5]) === [1,3,5,5] yields false
        //_identity(function(param){ return param;} === function(param){ return param;} yields false
        //_.identiy(1 + 2) === 3 yields true
      });
    });
    ...
    describe('first', function() {
      it('should be able to pull out the first element of an array', function() {
        ...
        // _.first([1,2,3], undefined) returns first element
        // _.first([1,2,3], null) returns first element
        //_.first([1,2,3], 1+1) returns [2,3]
        //var num = 2
        //_.first([1,2,3], num) returns [2,3]
      });
      ...
      it('should return empty array if zero is passed in as the index', function() {
        ...
        // _.first([1,2,3], []) returns []
        // _.first([1,2,3], -2) returns []
        // _.first([1,2,3], "nonsense") returns []
        // _.first([1,2,3], NaN) returns []
        // _.first([1,2,3], {name: "value"}) returns []
        // _.first([1,2,3], [1,3,5]) returns []
      });
    ...
    describe('last', function() {
      it('should pull the last element from an array', function() {
        ...
        //_.last([1,2,3]), undefined) returns last elem
        //_.last([1,2,3]), null) returns last elem
        //_.last([1,2,3], 1+1) math evaluated, returns relevant elem
        //var num = 2
        //_.last([1,2,3], num) returns relevant elem
      });
      ...
      it('should return empty array if zero is passed in as the index', function() {
        ...
        // _.last([1,2,3], []) [] & -[] returns []
        // _.last([1,2,3], -2) neg num including 0 & -0 returns [] 
        // _.last([1,2,3], "nonsense") string returns [1,2,3]
        // _.last([1,2,3], NaN) NaN returns [1,2,3]
        // _.last([1,2,3], {name: "value"}) object returns [1,2,3]
        // _.last([1,2,3], [1,3,5]) array returns [1,2,3]
      });
