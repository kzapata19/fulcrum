  ...
  describe('Part II', function() {
    ...
    describe('every', function() {
      ...
      it('passes by default for an empty collection', function() {
        expect(_.every([], _.identity)).to.be.true; // "!![]"" yields true
      });
      ...
      it('should work when provided a collection containing undefined values', function() {
        expect(_.every([undefined, undefined, undefined], _.identity)).to.be.false; //!!undefined yields false
      });

      it('should cast the result to a boolean', function() {
        expect(_.every([1], _.identity)).to.be.true; // !!1 yields true
        expect(_.every([0], _.identity)).to.be.false; //!!0 yields false
      });
